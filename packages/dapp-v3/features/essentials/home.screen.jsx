...
import { getWalletBalances, getWalletTxs } from 'dapp/services';
...
export default function HomeScreen({ navigation }) {
  ...
  useEffect(() => {
    const getBalances = async () => {
      const thisBalances = await getWalletBalances(isSignerSet, account.address);
        ...
        ListHeaderComponent={
          <Box mt="4">
            <FeatureHomeCard
              ...
              itemBottom={false}
            />
            <SectionHeader title="Assets" actionText="Swap" action={() => handleOnPress()} />
